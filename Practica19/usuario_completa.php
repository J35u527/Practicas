...
//Porque la maestra djo
	...
	//Borrar los datos para que no esten en sesion
...
<html lang="es">
    ...
    <body>
		...
		<form method="get" name="contacto" action="php/confirmaUsuario.php" >
		<fieldset>
		<legend>Usuario y Correo</legend>
			<label id="nombre_u">Nick de usuario</label>
			<input class="form_inputs" type="text" readonly="readonly" id="nombre_Us" name="nombre_Us" value="<?= $nick; ?>"/><br />
			<label for="mail">Correo</label>
			<input class="form_inputs" type="email" readonly="readonly" id="mail" name="mail" value="<?= $correo; ?>"/ />
		</fieldset>
	...
	<fieldset id="checkboxes">
     ...
     <legend>Avatar y password</legend>
		...
		<input class="form_inputs" type="password" id="pass" name="pass" required="required" value="*****"/>
	  </fieldset>
  ...
  <legend>Ingresar datos de contacto</legend>
	...
	<input class="form_inputs" type="tel" id="phone" name="tel"  /> <br />
	<label for="direccion">Fecha de Nacimiento</label>
	<label class="error" id="adv_birthday">Ingrese una fecha valida</label> <br /> 
	<input type="text" id="datepicker" class="calendario" name="fecha_nac">
 </fieldset>
 <br /> 
